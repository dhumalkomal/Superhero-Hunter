...
async function searchHeros(textSearched) {
     ...
     await fetch(`https://gateway.marvel.com/v1/public/characters?nameStartsWith=${textSearched}&ts=1694196523910&apikey=3733b92e95366f8e49d13ecabd84d7fa&hash=86d6668da9c20313fe38e6c98788cbe3`)
          ...
          if (count <= 5) {
               ...
               <li class="flex-row single-search-result">
                    ...
                    <div class="flex-col buttons">
                         ...
                         <button class="btn add-to-fav-btn">${favouritesCharacterIDs.has(`${hero.id}`) ? "<i class=\"fa-solid fa-heart-circle-minus\"></i> &nbsp; Remove " :"<i class=\"fa-solid fa-heart fav-icon\"></i> &nbsp; Add to Fav</button>"}
                    </div>
...
function addToFavourites() {
     ...
     if (this.innerHTML == '<i class="fa-solid fa-heart fav-icon"></i> &nbsp; Add to Fav') {
     ...
     // For removing the character form favourites array
          ...
          this.innerHTML = '<i class="fa-solid fa-heart fav-icon"></i> &nbsp; Add to Fav';
