...
function removeCharacterFromFavourites() {
    ...
    //  console.log(localStorage.getItem("favouriteCharacters"));
    //  console.log(localStorage.getItem("favouritesCharacterIDs"));
     ...
     console.log("idOfCharacterToBeDeleted:", idOfCharacterToBeDeleted);
